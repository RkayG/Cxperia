...
const DownloadOptions: React.FC<DownloadOptionsProps> = ({ qrCodeImageUrl, productName }) => {
  ...
  const handleDownload = (format: string) => {
    ...
    showToast.loading('Téléchargement...');
    ...
    <div className="p-8 max-w-md mx-auto">
      ...
      <div className="text-center mb-8">
        ...
        <h3 className="text-2xl font-bold text-gray-900 mb-2">
          Télécharger votre code QR
        </h3>
        <p className="text-gray-600 leading-relaxed">
          Fichiers PNG haute résolution et PDF prêts pour l'impression sur votre emballage
        </p>
      </div>
              ...
              <div className="flex items-center">
                ...
                <div className="text-left">
                  ...
                  <div className="text-sm text-gray-500">
                    {format === 'PNG' ? 'Fichier image haute qualité' : 'Document prêt à imprimer'}
                  </div>
                </div>
              </div>
