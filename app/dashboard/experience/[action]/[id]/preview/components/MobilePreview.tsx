...
const MobilePreview: React.FC<MobilePreviewProps> = ({ experienceId, refreshTrigger }) => {
  ...
  const previewUrl = experienceUrl;
  ...
  // Auto-refresh iframe when refreshTrigger changes
  React.useEffect(() => {
  ...
  const handleReload = () => {
    ...
    // Set a timeout to clear loading state if iframe doesn't load
