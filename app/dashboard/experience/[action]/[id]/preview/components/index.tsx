...
export default function PreviewPage() {
  ...
  // Handler to allow BrandColorPicker to trigger tab switch and iframe refresh
  const handleBrandColorApplied = () => {
    if (isMobileOrTablet) {
      setActiveTab("preview");
    }
    // Trigger iframe refresh by incrementing refreshTrigger
      ...
      <div className="min-h-screen bg-gray-50 border items-center justify-center rounded-2xl p-4 sm:p-6 lg:p-8 flex flex-col">
        ...
        <div className="mb-8">
          ...
          <p className="text-sm sm:text-base text-gray-600">
            Aperçu et interagissez avec votre expérience produit comme le feront vos clients.
          </p>
        </div>
        ...
        {!experienceId ? (
          <div className="text-center text-gray-500 py-12">
            Chargement de l'aperçu de l'expérience...
          </div>
        ) : isMobileOrTablet ? (
            ...
            <div className="flex-1 min-h-[400px]">
              {activeTab === "preview" && (
                <div className="w-full flex flex-col items-center">
                  <MobilePreview experienceId={experienceId} refreshTrigger={refreshTrigger} />
                </div>
              )}
              {activeTab === "brand" && (
                <div className="w-full flex flex-col items-center">
