...
const NewExperienceStep: React.FC<NewExperienceStepProps> = ({
  ...
  return (
    <div className="relative mx-auto mb-32 px-1.5 md:px-8 h-screen py-4">
      <ScrollToTop />
      {showSavingOverlay && <SavingOverlay visible={true} message="Sauvegarde de votre progression..." />}
      ...
      <div className="mx-auto">
        <div className="rounded-2xl border-gray-200 bg-white px-4 shadow-sm sm:border sm:px-6">
          ...
          <div className="mb-8">
            <div className="mb-6">
              <h2 className="text-2xl font-semibold text-gray-900 md:mt-4">Décrivez votre produit</h2>
            </div>
        ...
        <div className="float-right mt-12 mr-8 flex flex-col justify-end gap-3 pt-6 pb-32 sm:flex-row sm:gap-4">
          ...
          >
            {isLoading || isSubmitting ? "Sauvegarde..." : isUploadingImages ? "Téléchargement..." : buttonLabel}
          </button>
        </div>
      </div>
    </div>
