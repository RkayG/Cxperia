...
const StepOne: React.FC<StepOneProps> = ({ 
  ...
  const handleNext = async () => {
    ...
    try {
      ...
      const payload = {
        ...
        estimated_usage_duration_days:
          (experienceData as Experience).estimated_usage_duration_days ?? 30,
  ...
  return (
    <div className="h-screen py-4 mb-32 sm:px-6 mx-auto lg:px-8 relative">
      <ScrollToTop />
      {showSavingOverlay && (
        <SavingOverlay visible={true} message="Saving your progress..." />
      )}

      <div className="mx-auto">
        <div className="bg-white rounded-2xl shadow-sm sm:border border-gray-200 p-6 sm:p-8">
          ...
          <div className="mb-8">
            <div className="mb-6">
              ...
              <p className="text-gray-600 text-md">
                Provide essential details about your product, including its name
                and a comprehensive description.
              </p>
            </div>

            <ProductForm
              data={experienceData as Experience}
         ...
         {/* Action Buttons */}
          <div className="flex flex-col float-right mr-8 pb-32 sm:flex-row gap-3 mt-12 sm:gap-4 justify-end pt-6 ">
            
            <button
              onClick={handleNext}
              disabled={isLoading || isSubmitting}
              className=" sm:w-auto w-fit  px-8 py-3.5 bg-purple-800 hover:bg-purple-700 disabled:bg-gray-400 text-white font-medium rounded-xl transition-colors duration-200 order-1 sm:order-2"
            >
