...
import { Building2, Upload, Save, Globe, MapPin, Phone, Mail, DollarSign, Pencil, Euro } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 mb-32">
      ...
      <div className="flex items-center justify-between">
        ...
        {/* Desktop Edit Button */}
          ...
          <p className="text-gray-600 mt-1">
            Gérez vos informations de marque et vos paramètres
          </p>
        </div>
      ...
      <div className="bg-gray-50 rounded-lg p-6">
        <h3 className="text-lg font-medium text-gray-900 mb-4">Logo de la marque</h3>
        <div className="flex items-center gap-6">
          ...
          <div>
            ...
            >
              <Upload size={16} />
              {logoFile ? 'Changer le logo' : 'Upload Logo'}
            </label>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-purple-500 disabled:bg-gray-50"
            >
              <option value="">Sélectionner le volume</option>
              <option value="0-100">0-100 commandes</option>
              <option value="100-500">100-500 commandes</option>
              <option value="500-1000">500-1000 commandes</option>
      ...
      {/* Business Address */}
      <div className="border-t border-gray-200 pt-6">
        <h3 className="text-lg font-medium text-gray-900 mb-4">Adresse de l'entreprise</h3>
          ...
          <div className="md:col-span-2">
            ...
            <div className="relative">
              ...
              <textarea
                ...
                placeholder="Entrez votre adresse de l'entreprise"
              />
            </div>
          </div>
      ...
      {/* Plan Information */}
      <div className="border-t border-gray-200 pt-6">
        <h3 className="text-lg font-medium text-gray-900 mb-4">Informations du plan</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">
              Plan Tier
