  ...
  return (
    ...
    <div className="relative w-[90%] mx-auto mt-4 mb-8 hidden md:block h-32">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-center z-10">
        ...
        >
          Bonjour, {brand?.name || storeBrand?.name || ''}
        </h1>
    ...
    <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8" suppressHydrationWarning>
      <div className="px-4 py-6 sm:px-0">
        {/* Welcome Header */}
        <div className="mb-8 ">
          <h1 className="text-3xl font-bold text-gray-900 md:hidden">Bienvenue, {brand.name}</h1>
          <p className="text-gray-600 mt-2">
            Voici ce qui se passe avec votre marque aujourd'hui.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white overflow-hidden border rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              <dt className="text-sm font-medium text-gray-500 truncate">Expériences Actives</dt>
              <dd className="mt-1 text-3xl font-semibold text-green-600">{stats?.publishedExperiences || 0}</dd>
            </div>
          </div>
          <div className="bg-white overflow-hidden border rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              <dt className="text-sm font-medium text-gray-500 truncate">Expériences Brouillons</dt>
              <dd className="mt-1 text-3xl font-semibold text-yellow-600">{stats?.draftExperiences || 0}</dd>
            </div>
          </div>
          <div className="bg-white overflow-hidden border rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              <dt className="text-sm font-medium text-gray-500 truncate">QR Scans Aujourd'hui</dt>
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
              ...
              >
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <h3 className="text-sm font-medium text-gray-900">Créer des Expériences</h3>
                    <p className="text-sm text-gray-500">Construisez des expériences digitales</p>
                  </div>
                </div>
              </Link>
              ...
              >
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <h3 className="text-sm font-medium text-gray-900">Créer des Tutoriels</h3>
                    <p className="text-sm text-gray-500">Construisez et gérez vos tutoriels</p>
                  </div>
                </div>
              </Link>
            </div>
    ...
    <div className="mb-24 min-h-screen">
      ...
      <div className="w-full px-4">
        <div className="flex items-center px-2 justify-between mb-4">
          <h2 className="text-lg sm:text-xl font-semibold text-gray-800">Expériences Récentes</h2>
        </div>
      ...
      <div className="w-full px-4 mt-12">
        <div className="flex items-center px-2 justify-between mb-4">
          <h2 className="ml-1 text-lg sm:text-xl font-semibold text-gray-800">Tutoriels Récents</h2>
        </div>
        <Carousel className="w-full">
          <CarouselContent className="flex md:gap-4 gap-2 pb-4 -ml-4">
            {isLoadingTutorials ? (
      ...
      <div className="mx-auto px-4 max-w-6xl mt-16">
        {/* <div className="mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-2">Insights (Derniers 7 Jours)</h2>
