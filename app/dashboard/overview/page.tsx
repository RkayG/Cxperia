        ...
        <div className="flex-1 space-y-4 p-8 pt-6">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">
                  {metrics.experienceChange} depuis le mois dernier
                </p>
              </CardContent>
            </Card>
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">
                  {metrics.scanChange} depuis le mois dernier
                </p>
              </CardContent>
            </Card>
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">
                  {metrics.feedbackChange} depuis le mois dernier
                </p>
              </CardContent>
            </Card>
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">
                  {metrics.activeChange} depuis le mois dernier
                </p>
              </CardContent>
            </Card>
          </div>
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
            <Card className="col-span-4">
              <CardHeader>
                <CardTitle>Analyse des scans</CardTitle>
                <CardDescription>
                  Compteurs de scans mensuels sur toutes les expériences
                </CardDescription>
              </CardHeader>
            ...
            <Card className="col-span-3">
              <CardHeader>
                ...
                <CardDescription>
                  Derniers feedbacks de vos clients
                </CardDescription>
              </CardHeader>
              <CardContent>
