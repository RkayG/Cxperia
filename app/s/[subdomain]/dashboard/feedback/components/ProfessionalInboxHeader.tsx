...
const ProfessionalInboxHeader: React.FC<ProfessionalInboxHeaderProps> = ({
  ...
  const ratingOptions: FilterOption[] = [
    ...
    { value: '1', label: 'Poor', icon: <Star size={14} className="text-red-500 fill-current" /> },
    { value: '2', label: 'Fair', icon: <Star size={14} className="text-orange-500 fill-current" /> },
    { value: '3', label: 'Good', icon: <Star size={14} className="text-yellow-500 fill-current" /> },
    { value: '4', label: 'Great', icon: <Star size={14} className="text-blue-500 fill-current" /> },
