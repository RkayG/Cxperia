...
// Commented out the original multi-step signup code
/*
...
export default function SignupPage() {
  ...
  useEffect(() => {
    // Redirect to get-demo page immediately
    router.push('/get-demo');
  }, [router]);

  return (
    <div className="min-h-screen flex items-center justify-center bg-[#e9c0e9]">
      <div className="text-center">
        <h1 className="text-2xl font-bold text-[#502274] mb-4">
          Redirecting to demo request...
        </h1>
        <p className="text-gray-600">
          Please wait while we redirect you to schedule your demo.
        </p>
      </div>
    </div>
  );
