...
//  return (
//    <div className="bg-gradient-to-br from-slate-900 via-purple-900 to-slate-800 relative overflow-hidden">
//      {/* Background decorative elements */}
//      <div className="absolute inset-0 bg-gradient-to-r from-purple-500/10 to-blue-500/10"></div>
//      <div className="absolute top-0 right-0 w-96 h-96 bg-purple-500/5 rounded-full blur-3xl"></div>
//      <div className="absolute bottom-0 left-0 w-64 h-64 bg-blue-500/5 rounded-full blur-2xl"></div>
//      
...
//                Nivea Men
//              </h1>
//              <div className="w-12 h-1 bg-gradient-to-r from-purple-400 to-blue-400 rounded-full mt-2"></div>
//            </div>
